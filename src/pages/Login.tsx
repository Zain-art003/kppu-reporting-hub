        ...
        <div className="w-full max-w-md">
          <div className="glass-card p-6 md:p-8 animate-fade-in-up hover:shadow-xl transition-shadow duration-300">
            <div className="text-center mb-6">
              ...
              <h1 className="font-heading font-bold text-xl md:text-2xl text-foreground mt-4">Login</h1>
              <p className="text-muted-foreground text-sm mt-1">Masuk ke akun WBS KPPU Anda</p>
            </div>
